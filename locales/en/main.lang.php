...
L10n::$locales['Active writers'] = '';
L10n::$locales['Invite a new writer'] = '';
L10n::$locales['Author ID (login): '] = '';
L10n::$locales['Invite'] = '';
L10n::$locales['Back'] = '';
L10n::$locales['You are about to set permissions on the blog %1$s for user %2$s (%3$s).'] = '';
L10n::$locales['Save'] = '';
